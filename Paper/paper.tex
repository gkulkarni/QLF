...
\begin{figure}
  \begin{center}
    ...
    \includegraphics[width=\columnwidth,keepaspectratio]{rhoqso_test2.pdf}
...
\begin{table}
  ...
  \begin{tabular}{p{1.0cm}eee}
    ...
    $c_{3,2}$&3.773^{+0.017}_{-0.016} &    2.379^{+0.118}_{-0.085} &  \multicolumn{1}{c}{---} \\        
    $c_{3,3}$&141.884^{+31.521}_{-8.832} & 12.527^{+7.349}_{-3.618} & \multicolumn{1}{c}{---} \\        
    $c_{3,4}$&-0.171^{+0.101}_{-0.116} &   -0.229^{+0.135}_{-0.150} & \multicolumn{1}{c}{---} \\
    \hline
  \end{tabular}
\end{table}
...
\begin{figure*}
  \begin{center}
    % summary_grand.py
    \includegraphics[width=\textwidth]{/Users/girish/Desktop/evolution_grand.pdf}
  \end{center}
  \caption{A comparison of our inferred double power law parameter
    values with those reported in the literature.  Yellow points show
    our determinations from Figure~\ref{fig:evoln}.  \new{(Our
      statistical errors are often smaller than the symbol size.)}
    Other data points show values from
    \citet[triangles]{2012ApJ...755..169M},
    ...
    \citet[hexagons]{2009MNRAS.399.1755C} and \citet[rightward
      triangles]{2009A&A...507..781S}.  \new{Measurements for which no
      error bars are available are shown using open symbols.}  Where
    necessary, values from the literature have been converted to our
    cosmology.
...
\begin{table*}
  ...
  \begin{tabular}{ccc....}
    ...
    \multicolumn{1}{c}{$(M_{1450}<-21)$} \\
    \hline
    0.31$^a$ & 0.10 & 0.40 & 0.41^{+0.01}_{-0.01} & 0.55^{+0.02}_{-0.02} & 0.27^{+0.01}_{-0.01} & 0.36^{+0.02}_{-0.01} \\
...
\begin{table*}
  ...
  \begin{tabular}{d......}
    ...
    \multicolumn{1}{c}{$(M_{1450}<-21)$} \\
    \hline
    0.0 & 23.13^{+0.33}_{-0.20} & 22.79^{+0.13}_{-0.15} & 23.01^{+0.33}_{-0.20} & 22.67^{+0.13}_{-0.15} & -13.66^{+0.08}_{-0.05} & -13.86^{+0.03}_{-0.03} \\
...
\begin{table*}
  ...
  \begin{tabular}{d......}
    ...
    \multicolumn{1}{c}{$(M_{1450}<-21)$} \\
    \hline
    5.1 & 24.31^{+0.18}_{-0.29} & 23.93^{+0.09}_{-0.17} & 24.18^{+0.18}_{-0.29} & 23.80^{+0.09}_{-0.17} & -13.17^{+0.19}_{-0.30} & -13.56^{+0.10}_{-0.17} \\
...
\begin{table*}
  ...
  \begin{tabular}{d......}
    ...
    \multicolumn{1}{c}{$(M_{1450}<-21)$} \\
    \hline
    10.1 & 20.76^{+1.12}_{-1.13} & 19.88^{+0.75}_{-1.10} & 20.64^{+1.12}_{-1.13} & 19.76^{+0.75}_{-1.10} & -19.86^{+1.14}_{-1.14} & -20.74^{+0.75}_{-1.11} \\
