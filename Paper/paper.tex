...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{emissivity.pdf}
...
It is a pleasure to acknowledge useful discussions with James Aird,
Manda Banerji, Tirthankar Roy Choudhury, George Efstathiou, Xiaohui
Fan, Andrea Ferrara, Prakash Gaikwad, Martin Haehnelt, Paul Hewett,
Sergey Koposov, Donald Lynden-Bell, Roberto Maiolino, Richard McMahon,
Ewald Puchwein, Gordon Richards, Alberto Rorai, and Stephen Warren.
GK acknowledges support from ERC Advanced Grant 320596 `The Emergence
of Structure During the Epoch of Reionization'. \gk{Perhaps we need to
  specially thank people who shared data with us.  Gabor, Joe: do you
  need to add anything to acknowledgements?}
