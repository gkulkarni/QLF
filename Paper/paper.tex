...
\begin{figure}
  ...
  \end{center}
  \caption{Helium reionization. \gk{What is La Plante's luminosity
      limit?  Why is his redshift of reionization lower than ours?
      Waiting for Puchwein to give us his model.  Do we need a table
      for Q evolution of H and He?  Should we tabulate Helium
...
\begin{figure*}
  ...
  \end{center}
  \caption{Effect of including Giallongo qsos in our analysis.}
\end{figure*}
...
\begin{figure*}
  ...
  \end{center}
  \caption{Comparison of our LFs with Giallongo's LFs.}
\end{figure*}
...
software license.  \gk{Remember to make URL public and set appropriate
  license upon publication of paper.}
