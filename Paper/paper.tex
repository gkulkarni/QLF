...
%%GW: 2.5<z<2.6 QSOs are missing in this plot! Also, there are no open symbols for BOSS, but the numbers indicate that you excluded some in several redshift bins. The total numbers per redshift bin are not matching the number of BOSS QSOs.
\begin{figure*}
  \begin{center}
    \includegraphics[width=\textwidth,keepaspectratio]{mosaic_small.pdf}
    % mosaic.py 
  \end{center}
  \caption{Homogenised quasar luminosity functions at $\lambda=1450$\,\AA\ in redshift bins from
    ...
    \citet[brown]{2013ApJ...768..105M},
    \citet[pink]{2016ApJ...833..222J},
    \citet[orange]{2010AJ....139..906W}, and
    \citet[grey]{2015ApJ...798...28K}.  Open circles in
    corresponding colours indicate excluded incomplete magnitude bins for
    the respective data sets. In each panel we give the number
    of considered quasars in the respective redshift bin,
    with the number in parentheses indicating the total number of quasars before
    excluding incomplete magnitude bins.
    In each redshift bin, the black
