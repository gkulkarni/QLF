...
\begin{keywords}
dark ages, reionization, firs stars -- intergalactic medium -- quasars: general -- galaxies: active 
\end{keywords}
...
\begin{figure*}
  \begin{center}
    \includegraphics[height=0.88\textheight,keepaspectratio]{mosaic_small_global.pdf}
  \end{center}
...
Richards, and Alberto Rorai for helpful discussions.  GK is supported
by ERC Advanced Grant 320596 `The Emergence of Structure During the
