...
\begin{figure*}
  ...
  \caption{Luminosity function estimates from $z=0.3$ to $2.6$.  The
    ...
    bins. \textbf{[Remove redshift bins that were excluded from global
        analysis.]}}
  \label{fig:mosaic}
\end{figure*}
...
\begin{figure*}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{evol_28sep.pdf}
  \end{center}
...
\begin{figure*}
  \begin{center}
    \includegraphics[width=0.7\textwidth]{evolution_global_9oct.pdf}
  \end{center}
...
\begin{figure*}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{emissivity_18_9oct.pdf}
    \includegraphics[width=0.5\textwidth]{emissivity_20_9oct.pdf}
    \end{tabular}
  \end{center}
...
\begin{figure*}
  \begin{center}
    \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{g_18_10oct.pdf}
    \includegraphics[width=0.5\textwidth]{g_20_10oct.pdf}
    \end{tabular}
  \end{center}
