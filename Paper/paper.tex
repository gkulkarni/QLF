...
\begin{table*}
  \caption{Data sets analysed in this work.  We restrict the SDSS DR7
    data set \citep{2010AJ....139.2360S} to $z<4.7$.  The
    \citet{2013ApJ...768..105M} data set is restricted to faint
    ($M_{1450}>-26.73$) quasars to avoid overlap with the
    \citet{2016ApJ...829...33Y} sample.  Most AGN in the
    \citet{2015AA...578A..83G} sample do not have spectroscopic
    redshifts.  We therefore only use this sample for secondary
    analysis in Section~\ref{sec:global} and Appendix~\ref{sec:conv}.
    Similarly, the quasars reported by \citet{2011Natur.474..616M},
    \citet{2015ApJ...801L..11V}, and \citet{2018Natur.553..473B} have
    only approximate completeness estimates.  We only use these
    quasars in our secondary analysis in Section~\ref{sec:global}.}
  \label{tab:samples}
  \begin{tabular}{ccllrS}
    \hline
    & $z$ & Survey & Reference & Number & {Area} \\
    & & & & of quasars & {(deg$^2$)} \\
    \hline
    1. & 0.1--2.2 & SDSS DR7 & \citet{2010AJ....139.2360S} & 48664 & 6248.0 \\
    ...
    6. & 4.7--5.4 & SDSS+WISE & \citet{2016ApJ...829...33Y} & 99 & 14555.0 \\
    7. & 4.7--5.5 & SDSS DR7 & \citet{2013ApJ...768..105M} & 103 & 6248.0 \\
    8. & 4.7--5.4 & --- Stripe 82 & \citet{2013ApJ...768..105M} & 59 & 235.0 \\
    9. &3.7--4.8 & NDWFS & \citet{2011ApJ...728L..26G} & 12 & 1.71 \\
    10. &3.8--5.1 & DLS & \citet{2011ApJ...728L..26G} & 12 & 2.05 \\
    11. &4.1--6.3 & CANDELS GOODS-S & \citet{2015AA...578A..83G} & 19 & 0.047 \\
    12. & 5.8--6.4 & SDSS Main & \citet{2016ApJ...833..222J} & 24 & 11240.0 \\
    13. & 5.9--6.1 & --- Overlap & \citet{2016ApJ...833..222J} & 10 & 4223.0 \\
    14. & 5.7--6.1 & --- Stripe 82 & \citet{2016ApJ...833..222J} & 13 & 277.0 \\
    15. & 6.0 & CFHQS Deep & \citet{2010AJ....139..906W} & 1 & 4.47 \\
    16. & 5.9--6.4 & --- Very Wide & \citet{2010AJ....139..906W} & 16 & 494.0 \\
    17. & 6.0--6.2 & Subaru High-$z$ Quasar & \citet{2015ApJ...798...28K} & 2 & 6.5 \\
    18. & 6.5--7.4 & UKIDSS & \citet{2011Natur.474..616M} & 1 & 3370.0 \\
    19. & 6.5--7.4 & UKIDSS & \citet{2015ApJ...801L..11V} & 1 & 3370.0 \\
    20. & 6.5--7.4 & ALLWISE+UKIDSS+DECaLS & \citet{2018Natur.553..473B} & 1 & 2500.0 \\
    \hline
  \end{tabular}\\
\end{table*}
...
We started with compiling the samples of recent rest-frame UV-optical
...
\citet{2006AJ....131.2766R} due to improved $K$ corrections and IGM
...
Finally, we obtained a rough estimate of the
...
\begin{equation}
  V_\mathrm{bin} = \int_{M_\mathrm{min}}^{M_\mathrm{max}}dM
  \int_{z_\mathrm{min}}^{z_\mathrm{max}}dz\, f(M, z)\,\frac{dV}{dz},
  \label{eqn:vi}
\end{equation}
...
\begin{equation}
  \frac{dV}{dz\,d\Omega}=\frac{c}{H_0}\frac{d_L(z)^2}
       {(1+z)^2\sqrt{\Omega_m(1+z)^3+\Omega_\Lambda}},
  \label{eqn:dvdzdo}
\end{equation}
...
by
\begin{equation}
  d_L(z)=(1+z)\frac{c}{H_0}\int_0^z\frac{dz}
  {\sqrt{\Omega_m(1+z)^3+\Omega_\Lambda}}.
  \label{eqn:dl}
\end{equation}
Equations~(\ref{eqn:dvdzdo}) and (\ref{eqn:dl}) assume a flat Universe
($\Omega_k=0$).  The luminosity function $\phi$ has units of
...
of quasars in each bin.  The resultant binned luminosity function
estimates are shown by the points in Figure~\ref{fig:mosaic}.
...
law form.  We will fit such a form below.  However, we also see in
several redshift bins of Figure~\ref{fig:mosaic} that the luminosity
function seems to show a decline at the faint end.  This is clearly
seen, for example, in the 2SLAQ sample at $z<2$ and in the SDSS quasar
sample at $z<1.8$ and $z\sim 4$.  We take this to be a systematic
error.  The decrease in the luminosity function is an indication of
further low-level incompleteness in the quasar surveys that has not
been captured by the reported completeness values.  We choose to
discard such bins from our analysis.  The discarded luminosity bins
are shown in Figure~\ref{fig:mosaic} by open circles.
...
\begin{figure*}
  \begin{center}
    ...
    % mosaic.py 
  \end{center}
  \caption{Luminosity function estimates in redshift bins from
    $z=0.1$ to $6.5$.  The symbols show our inferred binned
    luminosity functions from various data sets:
    \citet[red]{2010AJ....139.2360S},
    \citet[green]{2009MNRAS.392...19C},
    \citet[blue]{2013ApJ...773...14R},
    \citet[yellow]{2016ApJ...829...33Y},
    \citet[brown]{2013ApJ...768..105M}, \citet[light
      blue]{2011ApJ...728L..26G},
    \citet[pink]{2016ApJ...833..222J},
    \citet[orange]{2010AJ....139..906W}, and
    \citet[grey]{2015ApJ...798...28K}.  Open circles in
    corresponding colours indicate excluded incomplete bins for
    the respective data sets.  In each redshift bin, the black
    curve shows the best-fit double power law model, which is
    represented by the median of the posterior probability
    distribution function.  The grey shaded area shows the
    one-sigma (68.26\%) uncertainty.  Each panel shows the number
    of quasars in the respective redshift bin.  The numbers in
    parentheses indicate the total number of reported quasars in
    the respective redshift bin, before excluding incomplete bins.
    See Sections~\ref{sec:binnedlf} and \ref{sec:bins} for further
    details.}
  \label{fig:mosaic}
\end{figure*}
...
\begin{figure*}
  ...
  \caption{Luminosity function estimates from $z=0.6$ to $6.5$.
    Similar to Figure~\ref{fig:mosaic}, the symbols show our
    inferred binned luminosity functions.  In each redshift bin,
    yellow curves show the best-fit double power law luminosity
    function in that redshift bin.  Other curves show the three
    global evolution models.  Shaded regions show the one-sigma
    (68.26\%) uncertainties.}
