...
def getParamG(individuals, param):
...
def plot_phi_star(fig, composite, ind2, individuals=None, compOpt=None, sample=False):
    ...
    zmean, zl, zu, u, l, c = getParamG(ind2, 0)
    left = zmean-zl
    right = zu-zmean
    uperr = u-c
    downerr = c-l
    ax.errorbar(zmean, c, ecolor='k', capsize=0,
                ...
                yerr=np.vstack((uperr, downerr)),
                fmt='None', zorder=6)
    ax.scatter(zmean, c, color='k', edgecolor='None', zorder=6, s=40)
...
def plot_m_star(fig, composite, ind2, individuals=None, compOpt=None, sample=False):
    ...
    zmean, zl, zu, u, l, c = getParamG(ind2, 1)
    left = zmean-zl
    right = zu-zmean
    uperr = u-c
    downerr = c-l
...
def plot_alpha(fig, composite, ind2, individuals=None, compOpt=None, sample=False):
    ...
    zmean, zl, zu, u, l, c = getParamG(ind2, 2)
    left = zmean-zl
    right = zu-zmean
    uperr = u-c
    downerr = c-l
...
def plot_beta(fig, composite, ind2, individuals=None, compOpt=None, sample=False):
    ...
    zmean, zl, zu, u, l, c = getParamG(ind2, 3)
    left = zmean-zl
    right = zu-zmean
    uperr = u-c
    downerr = c-l
...
def summary_plot(ind2, composite=None, individuals=None, compOpt=None, sample=False):
    ...
    plot_phi_star(fig, composite, ind2, individuals=individuals, compOpt=compOpt, sample=sample)
    plot_m_star(fig, composite, ind2, individuals=individuals, compOpt=compOpt, sample=sample)
    plot_alpha(fig, composite, ind2, individuals=individuals, compOpt=compOpt, sample=sample)
    plot_beta(fig, composite, ind2, individuals=individuals, compOpt=compOpt, sample=sample)
